...
1. 下载llama-3模型
    ...
    snapshot_download(
        ...
        revision="main",
        use_auth_token="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")
    ```
...
![alt text](../images/img-3-3-1.png)
![alt text](../images/img-3-3-2.png)
![alt text](../images/img-3-3-3.png)
